...
const ViewConfigs = ({ view, fields } : { view: ViewDetailedData, fields: FieldsData }) => {
  /* Hide fields config */
  const hiddenFieldIds: Set<string> | undefined = view ? new Set(view.hiddenFieldIds) : undefined
  const numHidden = hiddenFieldIds?.size ?? 0
  /* Filter config */
                ...
                >
                  {
                    ...
                    : index === 1 ?
                      <FiltersConfig viewId={view?.id} fields={fields} filters={filters}/>
                    : index === 3 ?
